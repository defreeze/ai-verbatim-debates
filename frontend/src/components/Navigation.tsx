...
const Navigation: React.FC = () => {
  ...
  return (
    <>
      <nav className="bg-white border-b border-neutral shadow-sm px-4 py-2 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <span className="text-xl font-bold tracking-tight text-primary">discoursegraph.net</span>
        </div>
